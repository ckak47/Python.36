...
if __name__ == '__main__':
    ...
    FilePath = "D:\CDC\security project\QingDao 01QRC\FW Analyse\cp01.log"  # 绝对路径
    ...
    CSVPath="D:\CDC\security project\QingDao 01QRC\FW Analyse\cp01.csv"    # 绝对路径
    #将的字典写入相应的.csv 文件
    csvfile = file(CSVPath, 'wb');
    writer = csv.writer(csvfile, dialect='excel');
    writer.writerow(["Interface", "Type","Source","Destination","Service","Protocal","Date"]);
