...
def log_split_to_dict(log_line, dict_map):
    #
    # This log_split_to_dict only for Checkpoint R77.30.
    #
    log_line_split = log_line.split('"', 24)
    data_from_log = log_line_split[3]
    time_from_log = log_line_split[5]
    interface_from_log = log_line_split[7]
    action_from_log = log_line_split[13]
    service_from_log = log_line_split[15]
    source_ip = log_line_split[19]
    destination_ip = log_line_split[21]
    tcp_udp = log_line_split[23]
